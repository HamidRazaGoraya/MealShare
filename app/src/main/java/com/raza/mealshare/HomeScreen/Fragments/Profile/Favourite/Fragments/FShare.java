...
public class FShare extends Fragment {
    ...
    private void recycleViewSetUp() {
        ...
        AllDataBaseConstant.getInstance(requireContext()).allFavoritItemsDeo().LiveAllShared(1).observeForever(new Observer<List<MyFavoruitProduct>>() {
            @Override
