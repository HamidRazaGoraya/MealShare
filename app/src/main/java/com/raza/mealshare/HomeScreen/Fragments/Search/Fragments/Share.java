...
public class Share extends Fragment {
    ...
    private void recycleViewSetUp() {
        ...
        FirebaseFirestore.getInstance().collectionGroup(ref.AllFoodShared).whereEqualTo(ref.Share,true).whereEqualTo(ref.data_status,0).orderBy(ref.data_submission_time, Query.Direction.DESCENDING).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
