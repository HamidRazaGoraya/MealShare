...
public class AllPeoplesList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AllPeoplesList(Context context, ArrayList<PostedItems> postedItems) {
