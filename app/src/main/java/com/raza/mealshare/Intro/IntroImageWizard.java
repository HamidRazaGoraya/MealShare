package com.raza.mealshare.Intro;
...
public class IntroImageWizard extends AppCompatActivity {
    ...
    public class MyDdViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NotNull ViewGroup container, int position) {
            ...
            ((TextView) view.findViewById(R.id.recordTitle)).setText(about_title_array[position]);
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(IntroImageWizard.this, Home.class));
        finish();
    }
